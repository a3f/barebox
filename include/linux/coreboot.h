 ...
 * Copyright 2026 Brady Norander <brady.norander@mainlining.org>
 */
...
#define CB_TAG_MAINBOARD      0x03
#define CB_TAG_VERSION  			0x04
...
/* sysinfo struct to store info used Aby drivers
   points back to the main coreboot table */
struct coreboot_sysinfo {
	// TODO: Maybe add more stuff here?
	char *mainboard_vendor;
	char *mainboard_model;
