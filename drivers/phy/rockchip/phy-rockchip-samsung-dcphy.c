...
static int samsung_mipi_dcphy_probe(struct device *dev)
{
	...
	samsung->regmap = regmap_init_mmio(dev, regs,
	...
	samsung->phy = phy_create(dev, NULL, &samsung_mipi_dcphy_ops);
...
device_platform_driver(samsung_mipi_dcphy_driver);
