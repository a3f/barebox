...
static int clk_mt8195_topck_probe(struct device *dev)
{
	...
	hw = clk_hw_register_mux(dev, "mfg_ck_fast_ref", mfg_fast_parents,
...
static void clk_mt8195_topck_remove(struct device *dev)
{
