...
static int clk_mt8186_apmixed_probe(struct device *dev)
{
...
static void clk_mt8186_apmixed_remove(struct device *dev)
{
	struct device_node *node = dev->of_node;
...
static struct driver clk_mt8186_apmixed_drv = {
...
postcore_platform_driver(clk_mt8186_apmixed_drv);
