...
static int clk_mt8195_apmixed_probe(struct device *dev)
{
...
static void clk_mt8195_apmixed_remove(struct device *dev)
{
	struct device_node *node = dev->of_node;
