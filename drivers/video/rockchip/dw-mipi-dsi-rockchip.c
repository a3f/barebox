...
static const struct of_device_id dw_mipi_dsi_rockchip_dt_ids[] = {
	{ .compatible = "rockchip,px30-mipi-dsi",   .data = &px30_chip_data },
	{ .compatible = "rockchip,rk3128-mipi-dsi", .data = &rk3128_chip_data },
	{ .compatible = "rockchip,rk3288-mipi-dsi", .data = &rk3288_chip_data },
	{ .compatible = "rockchip,rk3399-mipi-dsi", .data = &rk3399_chip_data },
	{ .compatible = "rockchip,rk3568-mipi-dsi", .data = &rk3568_chip_data },
	{ .compatible = "rockchip,rv1126-mipi-dsi", .data = &rv1126_chip_data },
	{ /* sentinel */ }
};
