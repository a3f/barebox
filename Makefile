...
collect-policies: $(build-dir) FORCE
...
ifdef CONFIG_PBL_IMAGE
	...
	@echo  '  bareboxrelease  - Output the release version string (use with make -s)'
	@echo  '  bareboxversion  - Output the version stored in Makefile (use with make -s)'
	 echo  ''
